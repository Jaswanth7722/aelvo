  ...
  return (
    <div className="panel">
      <div className="grid grid-cols-2 gap-4 text-sm">
        {/* Provider + Model */}
        <div>
          <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Provider</div>
          <div className="text-ink font-semibold">{overview.provider}</div>
        </div>
        <div>
          <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Model</div>
          <div className="text-ink font-semibold">{overview.model}</div>
        </div>

        {/* Active Agents */}
        <div>
          <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Active Agents</div>
          <div className="text-accent-blue font-semibold">{overview.agents}</div>
        </div>

        {/* Uptime */}
        <div>
          <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Uptime</div>
          <div className="text-ink font-semibold">{formatDuration(overview.uptime)}</div>
        </div>
      </div>

      {/* Goal */}
      <div className="mt-4">
        <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Goal</div>
        <div className="text-ink text-sm truncate">{overview.goal}</div>
      </div>

      {/* Task */}
      <div className="mt-3">
        <div className="text-ink-muted text-xs uppercase tracking-wider mb-1">Task</div>
      ...
      <div className="mt-3">
        <div className="flex items-center justify-between text-xs mb-1">
          ...
          <span className="text-ink-soft">{progressPct}%</span>
        </div>
